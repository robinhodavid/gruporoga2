...
if (!class_exists ('EJR_Add_To_Cart')) :
	...
	Class EJR_Add_To_Cart {
		...
		public function __construct () {
			...
			add_filter ('add_to_cart_text', array($this, 'cambia_texto_boton'), 10, 1); //WooCommerce <2.1
			add_filter ('woocommerce_product_add_to_cart_text', array($this, 'cambia_texto_boton'), 10, 1);
			add_filter ('woocommerce_product_single_add_to_cart_text', array($this, 'cambia_texto_boton'), 10, 1);
			add_filter ('woocommerce_booking_single_add_to_cart_text', array($this, 'cambia_texto_boton'), 10, 1); //WC Bookings
			}
