...
<!-- style -->
<p class="description ht_ctc_subtitle"><?php _e( 'Select Style (Desktop)', 'click-to-chat-for-whatsapp' ); ?>:</p class="description">
...
<!-- Dekstop position -->
<!-- side - 1 -->
<p class="description ht_ctc_subtitle"><?php _e( 'Position to Place (Desktop)', 'click-to-chat-for-whatsapp' ); ?>:</p>
<div class="row ht_ctc_admin_desktop">
    <br>
